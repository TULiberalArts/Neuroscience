...
There are 3 areas of study in the Neuroscience Master's Program:
...
All MS applicants must meet the requirements for admission listed below. Application Deadline: **May 1, 2017**.

Admission to the MS program requires a bachelor's degree (B.S. or B.A.) in one of the following disciplines:
- Bioengineering
- Biology
